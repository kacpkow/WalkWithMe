...
public class MakeAnnouncementFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        editDescriptionButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                setDescription(strollDescriptionView.getText().toString(), v);
            }
        });
        ...
        cancelDetailsButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                alertDialog.setTitle("Do you want to cancel this announcement?");
                alertDialog.show();
            }
        });
    ...
    public void changeDetails(){
        ...
        changedAdvertisementData.setUserId(userId);
        changedAdvertisementData.setAdId(0);
